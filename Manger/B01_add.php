    ...
    <td width="100%" valign="top"><!-- Main Body -->
      <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr>
          ...
          <td class="system_title_cht">會員資料管理 - 新增</td>
        </tr>
      </table>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td bgcolor="#FFFFFF">&nbsp;</td>
          <td bgcolor="#FFFFFF">
		<form name="form1" method="post" action="B01_addDB.php" onSubmit="return jsCheck();" enctype="multipart/form-data">
          <table width="95%" border="0" align="center" cellpadding="0" cellspacing="1">
            ...
            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="1">
              ...
              <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
				...
				<input name="MPassword" type="password" class="form_input_w200" maxlength="20" id="MPassword"></td>
              </tr>
              <tr>
                <td colspan="4" background="images/body_sep_line.gif" height="2"></td>
              </tr>                                                        
         ...
         <tr>
              ...
              <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                ...
                <td colspan="3" class="list_txt"><input name="手機號碼" type="text" class="input-name" maxlength="20" id="手機號碼"></td>
                </tr>
              <tr>
                <td colspan="4" background="images/body_sep_line.gif" height="2"></td>
              </tr>
              <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                ...
                <td colspan="3" class="list_txt"><span class="tb-line1">
                  <input name="信箱" type="text" class="input-email" maxlength="100" id="信箱"/>
                </span></td>
                </tr>
                 <tr>
                <td colspan="4" background="images/body_sep_line.gif" height="2"></td>
