    ...
    <td width="100%" valign="top"><!-- Main Body -->
      <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr>
          ...
          <td class="system_title_cht">員工資料管理 - 修改</td>
        </tr>
      </table>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td bgcolor="#FFFFFF">&nbsp;</td>
          <td bgcolor="#FFFFFF">
		<form name="form1" method="post" action="A01_editDB.php" onSubmit="return jsCheck();" enctype="multipart/form-data">
          <table width="95%" border="0" align="center" cellpadding="0" cellspacing="1">
            ...
            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="1">
              ...
              <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                ...
                <td colspan="3" class="list_txt"><input name="MPassword" type="password" class="form_input_w200" maxlength="20" value="<?=$row["MPassword"]?>"></td>
              </tr>
              <tr>
                <td colspan="4" background="images/body_sep_line.gif" height="2"></td>
              </tr>                                                        
              <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                ...
                <td colspan="3" class="list_txt"><input name="MPasswordCheck" type="password" class="form_input_w200" maxlength="20" value="<?=$row["MPassword"]?>"></td>
                </tr>
              <tr>
                <td colspan="4" background="images/body_sep_line.gif" height="2"></td>
              </tr>                                                        
              <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                ...
                <td colspan="3" class="list_txt"><input name="MName" type="text" class="input-name" maxlength="20" value="<?=htmlspecialchars($row["MName"])?>"></td>
                </tr>
              <tr>
                <td colspan="4" background="images/body_sep_line.gif" height="2"></td>
              </tr>
              <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                ...
                <td colspan="3" class="list_txt">
                	<select name="職務類別" class="txt_input_180" id="職務類別">
                	  <option value="管理部"<?php if($row["職務類別"]=="管理部" || $row["職務類別"]=="") echo "selected" ?>>管理部</option>
                	  <option value="教練"<?php if($row["職務類別"]=="教練") echo "selected" ?>>教練</option>
                	  <option value="系統開發"<?php if($row["職務類別"]=="系統開發") echo "selected" ?>>系統開發</option>
                	  <option value="工讀生"<?php if($row["職務類別"]=="工讀生") echo "selected" ?>>工讀生</option>
                	</select>
                 </td>
              </tr>
              <tr>
              ...
              <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                ...
                <td colspan="3" class="list_txt"><input name="聯絡電話" type="text" class="input-name" maxlength="20" value="<?=htmlspecialchars($row["聯絡電話"])?>"></td>
                </tr>              <tr>
                <td colspan="4" background="images/body_sep_line.gif" height="2"></td>
              </tr>                                                        
              <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                <td width="110" align="right" class="list_sn">行動電話 ：</td>
                <td colspan="3" class="list_txt"><input name="行動電話" type="text" class="input-name" maxlength="20" value="<?=htmlspecialchars($row["行動電話"])?>"></td>
                </tr>
              <tr>
                <td colspan="4" background="images/body_sep_line.gif" height="2"></td>
              </tr>
              <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                ...
                <td colspan="3" class="list_txt"><span class="tb-line1">
                  <input name="MEMail" type="text" class="input-email" maxlength="100" value="<?=htmlspecialchars($row["MEMail"])?>" />
                </span></td>
                </tr>
              <td colspan="4" background="images/body_sep_line.gif" height="2"></td>
              </tr>
              <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                ...
                <td colspan="3" class="list_txt">
                	<input name="ChkEnable" type="radio" id="radio" value="Y" <?php if($row["Enable"]=="Y") echo "checked" ?>/>啟用
                	<input name="ChkEnable" type="radio" id="radio2" value="N"  <?php if($row["Enable"]=="N" || $row["Enable"]=="") echo "checked" ?>/><font color="red">停用</font>
                </td>
              </tr>
              <tr>
                <td colspan="4" background="images/body_sep_line.gif" height="2"></td>
