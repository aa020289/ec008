    ...
    <td width="100%" valign="top"><!-- Main Body -->
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td bgcolor="#FFFFFF">&nbsp;</td>
          <td bgcolor="#FFFFFF">
		<form name="form1" method="post" action="A02_editDB.php" onSubmit="return jsCheck();" enctype="multipart/form-data">
            ...
            <tr>
              ...
              <tr onmouseout="style.backgroundColor='#ffffff';" onmouseover="style.backgroundColor='#F0F0F0';">
                ...
                <table width="95%" border="0" cellpadding="0" cellspacing="1">
                  <tr>
                    <td width="10" >
                      <input type="checkbox" name="MPer[]" value="A"<?php if (trim(strstr($row["MPer"],'A')) != "") echo " checked";?> />
                    </td>
                    <td colspan="3" >A.權限</td>
                  </tr>
                  <tr>
                    <td width="10" >
                      <input type="checkbox" name="MPer[]" value="B"<?php if (trim(strstr($row["MPer"],'B')) != "") echo " checked";?> />
                    </td>
                    <td colspan="3" >B.其它1</td>
                  </tr>
                  <tr>
                    <td width="10" >
                      <input type="checkbox" name="MPer[]" value="C"<?php if (trim(strstr($row["MPer"],'C')) != "") echo " checked";?> />
                    </td>
