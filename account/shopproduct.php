                ...
                <div class="property_details">
                    ...
                    if (mysql_num_rows($rs) > 0) { 
                        ...
                        for ($i = 0; $i < $total; $i++) {
                            ...
                            echo "</a>";                            
                            echo "<h1>";
                            echo '<a href="#">' . $row["商品名稱"] . '</a>'. '</em><form action="checkout.php" method="POST"><input type=submit name="addCartOK" value="加到購物車" class="btn-cart"><input type=hidden name="buyproductno" value="' . $row['商品代號'] . '"><input type=hidden name="buyqty" value="1"></form>';
                            echo "</h1>";
                            echo "</div>";
                            echo "</li>";
                        }
